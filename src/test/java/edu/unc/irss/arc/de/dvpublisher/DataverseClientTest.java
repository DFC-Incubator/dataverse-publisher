...
public class DataverseClientTest {
	...
	@Before
	public void setUp() {
		System.out.println("injected test:apikey="
				+ System.getProperty("apiKey"));
		System.out.println("injected test:dataversealias="
				+ System.getProperty("dataverseAlias"));
		System.out.println("injected test:dataverseUrl="
				+ System.getProperty("dataverseUrl"));
	}
	...
	public void testPublishDatafile_String_File() throws MalformedURLException {
		...
		// DataverseClient instance = new
		// DataverseClient(System.getProperty("dataverseUrl"),
		// System.getProperty("apiKey"), System.getProperty("dataverseAlias"));
		//
